...
if (declared && StressTest.Test003.meta.constructor == Joose.MetaClass) {
...
Class('StressTest.Test003', {
	...
	body : function(){
			if (StressTest.Test011.meta.constructor != Joose.MetaClass) { 
			...
			if (StressTest.Test037.meta.constructor != Joose.MetaClass) { 
				__global__.unSatisfiedDeps = true;
