...
me.setCustomShape(customShape);me.applyRoles()
me.renderCustomShape()
})
},
applyRoles: function () {var me      = this;var strings = this.getCustomShape().getRoles();Joose.A.each(strings, function (s) {var name = "block.ui.role."+s
...
methods: {startListening: function ()  {var me = this;var interval = window.setInterval(function syncTimer () {me.update()
}, 2000)
