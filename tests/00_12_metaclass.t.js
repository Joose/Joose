...
testobj.testSanity = function() {
    ...
    this.ok(Joose.Kernel.MetaClass.meta.methodMetaClass == Joose.Kernel.ProtoMethod, "Methods of Joose.Kernel.MetaClass's meta are Joose.Kernel.ProtoMethods");
    this.ok(Joose.Kernel.MetaClass.meta.attributeMetaClass == Joose.Kernel.ProtoAttribute, "Attributes of Joose.Kernel.MetaClass's meta are Joose.Kernel.ProtoAttribute");
    
    this.ok(Joose.Class.prototype.methodMetaClass == Joose.Method, "Methods of Joose.Class itself were upgraded to Joose.Methods");
