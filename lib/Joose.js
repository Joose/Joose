...
//
//
//Joose.Kernel.XX = function () {
//    this.initialize.apply(this, arguments);
//}
//
//
//Joose.Kernel.XX.prototype = {
//	
//	_name 				: 'Joose.Kernel.XX',
//	attributes 			: {},
//	methods				: {},
//	
//	constructor : Joose.Kernel.XX,
//	meta : Joose.Kernel.XX,
//	
//	
...
//    	//do not override
//    	if (typeof this.nextGen.prototype[name] == 'undefined') this.nextGen.prototype[name] = func;
//    },
//    
//    
...
//    	//do not override
//    	if (typeof this.nextGen.prototype[name] == 'undefined') this.nextGen.prototype[name] = init;
//    }
//    
//}
//
...
//Joose.Kernel.BlastoGenesis = new Joose.Kernel.XX(Joose.Kernel.XX);
//
//Joose.Kernel.BlastoGenesis.addMethod('className', function () { return this._name } );
//Joose.Kernel.BlastoGenesis.addMethod('getName', function () { return this.className() } );
//Joose.Kernel.BlastoGenesis.addMethod('hasMethod', function (name) { return Boolean(this.methods[name]) } );
//Joose.Kernel.BlastoGenesis.addMethod('hasAttribute', function (name) { return Boolean(this.attributes[name]) } );
//
//
////viviparity, meta and parent class are still the same thing, but the class have been separated
//Joose.Kernel.BlastoGenesis.addMethod('parturiate', function () { 
//    baby = function(){ 
...
//    
//    //baby also receives all genes (attrs and methods) of mother, but overrides "meta" attribute
//    baby.prototype.meta = new Joose.Kernel.XX(baby);
...
//
//
//var ViviparityGenesis = BlastoGenesis.parturiate();
//Joose.Kernel = Joose.Kernel || {};
//
////Blastogenesis - meta, parent and the class itself are the same thing
//Joose.Kernel.BlastoGenesis = new Joose.Kernel.XX(Joose.Kernel.XX);
