...
//        anonymous : false,
    ...
    classMethods: {
        ...
        create : function (name, props){
            ...
            //XXX
            //XXX this code (and code from module) can be moved to handlePropuse, if it will allow special overriding
            if (props && props.use) {
...
//            });
            ...
            var anonymousNamespaceMeta = new Joose.Kernel.Namespace('');
            
            anonymousNamespaceMeta.readyListeners.unshift(function(){
                callback.call(scope || this);
            });
            
            anonymousNamespaceMeta._initializeFromProp('use', dependenciesInfo, {});
        },
