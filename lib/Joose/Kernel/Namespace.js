var namespaceMeta = new Joose.Kernel.Roles('Joose.Kernel.Namespace');
...
namespaceMeta.initializeFromProps({
    ...
    methods: {
        ...
        handlePropbody : function (bodyFunc) {
			if (bodyFunc) Joose.Kernel.Namespace.executeInNamespace(this.c, bodyFunc, this.container, [this.c]);
		},
