        ...
        prepareNamespace: function (name) {
            ...
            for(var i = 0; i < parts.length; i++) {
                ...
                if(typeof cur == "undefined") {
                    ...
                    //XXX should'nt we try to setup a meta (Joose.Kernel.NamespaceKeeper instance) if its absent?
    ...
    override : {
        initializeFromProps : function (props) {
            if (props && props.use) {
                ...
                props.SUPER = this.SUPER;
                me._initializeFromProp('use', props.use, props)
            } else {
    ...
    methods: {
        ...
        handlePropuse : function (dependenciesInfo, props) {
            ...
            Joose.A.each(dependenciesInfo, function(dependency) {
                ...
                if (this.dependencies[depName] && this.dependencies[depName].version != dependency.version) {
                    throw "Repeated usage with different version number";
                }
                if (!this.dependencies[depName]) {
                    dependency.Module = new Joose.Namespace("").getClassObject();
                    
                    dependency.Module.meta.readyListeners.push(function(){
                        delete me.dependencies[depName];
                        me.checkDependencies(props);
                    });
                    this.dependencies[depName] = dependency;
                }
            })
            
            Joose.O.eachSafe(this.dependencies, function(dependency, Module) {
                dependency.Module.load(props);
            })
            
            this.checkDependencies(props);
        },
        
        
        checkDependencies : function (props){
