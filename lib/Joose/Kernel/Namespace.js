    ...
    methods: {
        ...
        handlePropuse : function (dependenciesInfo, props) {
            ...
            Joose.A.each(dependenciesInfo, function(dependency) {
                ...
                if (!depName) throw "Empty dependency name for Module=[" + this.nextGeneration + "]";
                
                if (me.dependencies[depName] && me.dependencies[depName].version != dependency.version) {
                    throw "Repeated usage of " + dependency.Module + " with different version number for Module=[" + me.nextGeneration + "]";
                }
                if (!me.dependencies[depName]) {
                    ...
                    me.dependencies[depName] = dependency;
                }
            })
