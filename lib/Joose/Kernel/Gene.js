...
Joose.Kernel.Gene.prototype = {
	...
	//note, that these attributes are actually stored in prototype, not in the instance, so they are shared among all genes
	attributes 			: {},
	methods				: {},
    ...
    addMethod : function (name, func) {
    	...
    	if (this.nextGeneration) this.nextGeneration.prototype[name] = func;
    },
    
    
    addAttribute : function (name, init) {
    	this.attributes[name] = init;
    	if (this.nextGeneration) this.nextGeneration.prototype[name] = init;
    }
