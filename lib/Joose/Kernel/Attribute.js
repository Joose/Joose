Joose.Kernel.Attribute = new Joose.Kernel.Class('Joose.Kernel.Attribute', {
	...
	override : {
		...
		computeValue : function(props) {
			...
			if (props.is) {
				...
				this.role = new Joose.MetaRole('attribute:' + this.name, { methods : methods }).c;
			}
		},
...
// */
//Joose.Kernel.MetaClass.create('Joose.Kernel.Attribute', {    
