...
var protoMethodMeta = new Joose.Kernel.Parthenogenesis('Joose.Kernel.ProtoMethod', function (name, func) {
    this.initialize(name, func)
});


protoMethodMeta.addGenes({
...
//    isClassMethod: function () { return false },
    ...
    _makeWrapped: function (func) {
        return this.constructor(this.getName(), func); // Should there be , this.getProps() ???
    },
