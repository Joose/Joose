//inheritanceMeta is filled with introspection information, coz it is Joose.Kernel.ClassSeparation instanse
...
//        	if (!(attribute && joose.isInstance(attribute) )){ //without exception
    		if (!(attribute && attribute.meta && attribute.constructor == attribute.meta.nextGeneration )){
            	//lazy to avoid call during initialization
            	//if inheriting attibute "attributes" - initialize it with null, to avoid recursive data structure
...
//        this.attributes[at.getName()] = attribute;
        ...
        attribute.addToClass(this.nextGeneration)
    },
