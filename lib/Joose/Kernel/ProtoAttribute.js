...
var protoAttribute = new Joose.Kernel.Parthenogenesis('Joose.Kernel.ProtoAttribute', function (name, props) {
    this.initialize(name, props)
});


protoAttribute.addGenes({
...
//        meta.attributeNames.push(name)
        ...
        //dublication moved to addAttribute
...
Joose.Kernel.ProtoAttribute = protoAttribute.getClassObject();