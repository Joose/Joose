...
Joose.Kernel.ProtoAttribute = Joose.Kernel.Fissiparity.parturiate('Joose.Kernel.ProtoAttribute', function (name, props) {
    this.initialize(name, props)
});


Joose.Kernel.ProtoAttribute.meta.addGenes({
