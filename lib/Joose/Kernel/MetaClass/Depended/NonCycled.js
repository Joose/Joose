var protoModuleMeta = new Joose.Kernel.Roles('Joose.Kernel.MetaClass');
...
protoModuleMeta.initializeFromProps({
    ...
    classMethods: {
        ...
        prepareNamespace: function (name) {
            ...
            for(var i = 0; i < parts.length; i++) {
                ...
                if(typeof cur == "undefined") {
                    ...
                    if(!(cur && cur.meta && cur.meta.meta && cur.meta.meta.isa(Joose.Kernel.MetaClass))) {
        ...
        prepareVirtualNamespace: function (name) {
            ...
            return (this.virtualNamespaces[name] = new Joose.Kernel.MetaClass(name).getClassObject());
        },
        
        
        create: function (name, props){
            //last element in namespace chain
            var element = Joose.Kernel.MetaClass.prepareNamespace(name)
    ...
    methods: {
        ...
        handlePropbody: function (bodyFunc) {
            if (bodyFunc) Joose.Kernel.MetaClass.executeInNamespace(this.c, bodyFunc, this.container, [this.c]);
        },
...
Joose.Kernel.MetaClass = protoModuleMeta.getClassObject();
