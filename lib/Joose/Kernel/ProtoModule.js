var protoModuleMeta = new Joose.Kernel.Mammals('Joose.Kernel.ProtoModule');

protoModuleMeta.addGenes({
	_allModules : []
});
...
__global__ = new Joose.Kernel.ProtoModule("__global__");
__global__.setContainer(__global__);
__global__._allModules.push(__global__);
