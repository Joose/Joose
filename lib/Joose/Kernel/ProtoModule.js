...
protoModuleMeta.initializeFromProps({
    ...
    has: {
        ...
        //place where the namespace elements are stored. Generally its a c function (getClassObject()), but for global module it will be a joose.top
        container: {},
    ...
    classMethods: {
        ...
        prepareVirtualNamespace: function (name) {
            ...
            return (this.virtualNamespaces[name] = new Joose.Kernel.ProtoModule(name).getClassObject());
        },
        ...
        use: function (dependenciesInfo, callback, scope) {
            var anonymousNamespace = new Joose.Kernel.ProtoModule('').getClassObject();
    ...
    methods: {
        ...
        //it turns the descritor.Module string to the "namespace body" with meta, which is Joose.Kernel.ProtoModule
            ...
            if (!thisNamespace.meta.dependencies[depName]) {
                ...
                if (descriptor.Module) {
                    ...
                    if (descriptor.presence) {
                        descriptor.Module = Joose.Kernel.ProtoModule.prepareVirtualNamespace(descriptor.Module);
                        ...
                        descriptor.Module = Joose.Kernel.ProtoModule.executeInNamespace(__global__, function(){
                            //turning string into Namespace instance, possible creating new namespace
                            return Joose.Kernel.ProtoModule.prepareNamespace(descriptor.Module);
                        });
                    } 
                    ...
                    descriptor.Module = Joose.Kernel.ProtoModule.prepareVirtualNamespace(descriptor.url);
        ...
        handleLoad: function() {
            ...
            var onerror = function(){
                ...
                Joose.Kernel.ProtoModule.transports[thisNamespace.meta.transport].call(thisNamespace.meta, urls.shift(), onready, onerror);
            }
            
            //to avoid cycled recursion in getNamespace()
            onerror.__JOOSE_MODULE__ = __global__;
            
            Joose.Kernel.ProtoModule.transports[this.transport].call(this, urls.shift(), onready, onerror);
        },
...
use = function(){
    Joose.Kernel.ProtoModule.use.apply(Joose.Kernel.ProtoModule, arguments);
}
...
Joose.Kernel.ProtoModule.transports = {
