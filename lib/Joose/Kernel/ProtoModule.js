    ...
    classMethods: {
        ...
        create : function (name, props){
        	...
        	if (element) {
        		...
        		this.fillOwnNamespace(res.parent, element, res.globalName)
        	} else {
...
__JOOSE_MODULE__ = (new Joose.Kernel.ProtoModule("")).getClassObject();
__JOOSE_MODULE__.meta._name = '';
__JOOSE_MODULE__.meta.container = joose.top;
__JOOSE_MODULE__.meta.namespaceFilled = false;
