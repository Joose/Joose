...
viviparityMeta.addGenes({
	...
	addSuperClass : function (classObject) {
	    ...
	    if (!classObject.meta.hasMethod('isa') || !classObject.meta.hasMethod('getMethodObject')) throw "Class " + classObject + "can't be used as parent class";
...
//        this.attributes[at.getName()] = attribute;
    ...
    makeAnonSubclass: function () {
        //XXX
        var c = new this.constructor(this.className()+"__anon__"+joose.anonymouseClassCounter++);
