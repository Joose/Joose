...
Joose.Builder.Globals = {
    ...
    Module: function (name, props) {
        ...
        return Joose.Kernel.Namespace.create(name, props)
    },
    ...
    Type: function (name, props) {
        ...
        var nameSpace = Joose.Kernel.Namespace.getCurrentNamespace();
        if ( nameSpace == __global__) nameSpace = Joose.Type;

        return Joose.Kernel.Namespace.executeInNamespace(nameSpace, Joose.TypeConstraint.create, Joose.TypeConstraint, [name, props]);
    },
