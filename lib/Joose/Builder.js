...
Joose.Builder.Globals = {
    ...
    Type: function (name, props) {
        ...
        var nameSpace = Joose.Kernel.ProtoModule.getCurrentNamespace();
        if ( nameSpace == __global__) nameSpace = Joose.Type;

        return Joose.Kernel.ProtoModule.executeInNamespace(nameSpace, Joose.TypeConstraint.create, Joose.TypeConstraint, [name, props]);
    },
