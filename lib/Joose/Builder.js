...
Joose.Builder.Globals = {
    ...
    Class:    function (name, props) {
         ...
         * purposes. */
	    //XXX Joose.Class appears before declaration
	    ...
	    if (!metaClass.classCan('create')) throw "MetaClass [" + metaClass + "] can't be used with Class builder (have no class method 'create')";
