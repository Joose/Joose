...
Class("Joose.Storage.Engine", {
    ...
    classMethods: {
        ...
        pack: function (object, seen) {
            ...
            // This only works with json2 the first json will 
            // cause a recursive error if your attributes contain 
            // other joose objects. However, since we have no way of
            // determining which json version we are using you are on
            // your own. (JWall)
