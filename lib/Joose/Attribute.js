Joose.Attribute = new Joose.Kernel.Class('Joose.Attribute', {
...
//				debugger;
				...
				this.value = new Joose.MetaRole('attribute:' + this.name, { methods : methods }).c;
			}
		},
...
//	    	debugger;
	    	if (this.value) targetClass.meta.extend({
	    		does : [ this.value ]
	    	})
	    },
	    ...
	    unapply : function(from) {
	    	if (this.value) from.meta.extend({
	    		doesnt : [ this.value ]
	    	})
	    }
