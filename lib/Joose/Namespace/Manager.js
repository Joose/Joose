    ...
    my : {
        ...
        methods : {
            ...
            initialize : function(){
                ...
                global.meta.ns.addProperty('Joose', new Joose.Namespace.Keeper("Joose", { constructor : Joose }).c)
                
                Joose.meta.ns.addProperty('Kernel', new Joose.Namespace.Keeper("Joose.Kernel", { constructor : Joose.Kernel }).c);
...
//                    		throw "Re-declaration of class with different meta is not allowed";                    		
	        ...
	        prepareVirtual: function (name) {
	            ...
	            return this.virtual[name] = new Joose.Namespace.Keeper(name, {
	            	isLoadingStub : true
	            }).c;
	        },
