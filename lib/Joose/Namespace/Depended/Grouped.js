Role('Joose.Namespace.Depended.Grouped', {
    
    requires : [ 'processDependencies', 'addDescriptor' ],

    have: {
        groupedDependencies: null
    },
    ...
    builder : {
	    ...
	    before : {
	        use: function (targetClassMeta, depInfo) {
	            ...
	            targetClassMeta.groupedDependencies = targetClassMeta.groupedDependencies || {};
	        }
	    }
    ...
    after : {
        processDependencies : function () {
            if (this.groupedDependencies) {
                ...
                delete this.groupedDependencies[this.name];
        ...
        copyNamespaceState : function (targetClass) {
            ...
            targetMeta.dependenciesGroup    = this.dependenciesGroup;
        }
    ...
    override : {
        ...
        getUrls: function () {
            ...
            return __JOOSE_LIBRARIAN_ROOT__.concat( Digest.MD5.my.md5_hex(this.stringifyDependencies()) + '.js' ).join('/');
        },
...
Joose.MetaClass.meta.extend({
    does                        : [ Joose.Namespace.Depended.Grouped ]
});
