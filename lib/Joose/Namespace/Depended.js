    ...
    override: {
        ...
        extend: function(props) {
            ...
            if (props.use) {
                ...
                thisNamespace.meta.builder.use(this, depInfo)
            } else {
                this.SUPER(props);
...
//                    Joose.Kernel.MetaClass.Depended.Transport.ScriptTag.meta.apply(descriptor.Module.meta);
        ...
        needDescriptor : function (descriptor) {
            ...
            return !( this.dependencies[descriptor.depName] || (descriptor.Module.meta.ready && !descriptor.Module.meta.isLoadingStub) );
        },
...
//        	if (this.isLoadingStub) return;
        ...
        handleLoad: function() {
            ...
            try {
                if (this.loaded && !this.isLoadingStub || typeof this.presence == 'function' && this.presence()) {
                    this.finalizeDependencies();
                    return;
                }
            } catch (e) { }
