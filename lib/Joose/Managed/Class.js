...
//        this.adoptConstructor();
    ...
    prepareCore : function(){
        var builderClass = this.superClass.meta.builder ? this.superClass.meta.builder.constructor : Joose.Managed.Builder;
        ...
        var stemClass = this.superClass.meta.stem ? this.superClass.meta.stem.constructor : Joose.Managed.Stem.ClassStem;
