...
//    },
    ...
    prepareCore : function(){
        ...
        if (this.meta instanceof Joose.Proto.Class) builderClass = new Joose.Proto.Class(null, null, builderClass);
        else builderClass = new this.meta.constructor(null, { isa : builderClass });

        
        var stemClass = this.superClass.meta.stem.constructor;
        
        if (this.meta instanceof Joose.Proto.Class) stemClass = new Joose.Proto.Class(null, null, stemClass);
        else stemClass = new this.meta.constructor(null, { isa : stemClass });

        this.builder = new builderClass({ targetClass : this.c });
        this.stem = new stemClass({ targetClass : this.c });
    },
