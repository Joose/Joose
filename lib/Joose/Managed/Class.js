Joose.Managed.Class = new Joose.Proto.Class('Joose.Managed.Class', {
    ...
    prepareStem : function(extend){
        this.builderClass = new this.meta.constructor('builder_of_' + this.name, { 
            isa : this.superClass.meta.builderClass || this.meta.builderClass || this.builderClass
        }).c;
        
        this.stemClass = new this.meta.constructor('stem_of_' + this.name, {
            isa : this.superClass.meta.stemClass || this.meta.stemClass || this.stemClass
        }).c;
    },
    
    
    finalizeStem : function(extend){
        this.SUPER();
