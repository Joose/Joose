Joose.Managed.Class = new Joose.Proto.Class('Joose.Managed.Class', {
    ...
    processStem : function(extend){
        ...
        var builderClass = this.getAttribute('builderClass');
        if (builderClass instanceof Joose.Managed.Property.Attribute) builderClass = builderClass.value;
        if (builderClass) this.addAttribute('builderClass', thisMeta.subClassOf(builderClass));
        
        var stemClass = this.getAttribute('stemClass');
        if (stemClass instanceof Joose.Managed.Property.Attribute) stemClass = stemClass.value;
