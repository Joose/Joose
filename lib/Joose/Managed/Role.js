Joose.Managed.Role = new Joose.Proto.Class('Joose.Managed.Role', null, Joose.Proto.Class, {
    ...
    prepareCore : function(){
        ...
        this.stem = new Joose.Managed.Stem.RoleStem(this.name);
    },
...
//Joose.Managed.Role.meta.extend({
//    builder : {
//        
//        require : function(targetClassMeta, info) {
//            Joose.A.each(info, function(methodName) {
//                targetClassMeta.stem.properties.requirements.addProperty(methodName, {});
//            }, this);
//        }
//        
//    }
