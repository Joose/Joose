Joose.Managed.My = new Joose.Managed.Role('Joose.Managed.My', {
    ...
    methods : {
        createMy : function (extend) {
            ...
            // Symbiont will generally have the same meta class as its hoster, excepting the cases, when the superclass (either direct of default) 
            // also have the symbiont. In such cases, the meta class for symbiont will be inherited (unless explicitly specified)
            if (!myExtend.meta && myExtend.isa != this.defaultSuperClass) myExtend.meta = this.constructor
