__global__.addProperty('Class', function(name, props){
    ...
    return Joose.Namespace.Manager.my.create(name, props, metaClass); 
});


__global__.addProperty('Role', function(name, props){
    return Joose.Namespace.Manager.my.create(name, props, Joose.Managed.Role); 
});


__global__.addProperty('Module', function(name, props){
    return Joose.Namespace.Manager.my.create(name, props, Joose.Namespace.Keeper); 
});
