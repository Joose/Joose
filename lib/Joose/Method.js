Joose.Kernel.MetaClass.create('Joose.Method', {	
	isa : Joose.Kernel.ProtoMethod,
	meta : Joose.Kernel.MetaClass
});

Joose.Kernel.MetaClass.meta.addAttribute('methodConstructor', { init : Joose.Method, lazy : true });
...
//(function (Class) {
//
////copied to protomethod, need to upgrade meta to class
////copied
////copied
//Class("Joose.Method", {
//    methods: {
