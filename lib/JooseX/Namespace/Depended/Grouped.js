Role('JooseX.Namespace.Depended.Grouped', {
    ...
    after : {
        processDependencies : function () {
            if (this.groupedDeps) {
                ...
                delete this.groupedDeps[this.name];
        ...
        addDescriptor: function (descriptor) {
            ...
            if (!dependedMeta.groupedDeps && !descriptor.url) {
                ...
                if (this.groupedDeps[depName]) {
                    ...
                    if (this.groupedDeps[depName].version > descriptor.version) return;
                }
                
                //otherwise - adding/overwriting dependency
                this.groupedDeps[depName] = descriptor;
            }
        }
    ...
    methods: {
        ...
        handleGroupLoad: function() {
            ...
            for (var i in groupedDeps) if (groupedDeps.hasOwnProperty(i)) {
                haveAny = true;
                if (groupedDeps[i].Module.meta.loaded) return
            }
            ...
            try {
                req.getText({
                    ...
                    callback: function(success, text) {
                        ...
                        Joose.O.eachSafe(me.groupedDeps, function(descriptor) {
                            var dependedMeta = descriptor.Module.meta;
        ...
        stringifyDependencies: function(){
            ...
            Joose.O.eachSafe(this.groupedDeps, function(descriptor, depName) {
