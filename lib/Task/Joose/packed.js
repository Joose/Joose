...
Joose.Managed.My = new Joose.Managed.Role('Joose.Managed.My', {
    ...
    methods : {
	    createMy : function (extend) {
	        ...
	        var myClass = this.myClass = isRole ? new thisMeta.superClass(null, myExtend).c : this.subClassOf(this.superClass.meta.myClass || thisMeta.defaultSuperClass.meta.myClass || thisMeta.defaultSuperClass, myExtend)
