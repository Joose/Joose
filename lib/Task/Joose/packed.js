            ...
            create : function (nsName, metaClass, extend, currentNs) {
                ...
                for(var i = 0; i < parts.length; i++) {
                    ...
                    if (typeof cur == "undefined") {
                    	...
                    	if (isLast && !(cur && cur.meta && cur.meta.meta && cur.meta.meta.hasAttribute('ns'))) debugger;//throw "Trying to setup module " + soFarName + " failed. There is already something: " + cur
